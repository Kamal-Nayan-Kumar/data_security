...
\IEEEauthorblockA{\textit{IIIT Dharwad} \\ \textit{DSAI} \\ 23bds026@iiitdwd.ac.in}
\and
\IEEEauthorblockN{Rahul Patel}
\IEEEauthorblockA{\textit{IIIT Dharwad} \\ \textit{DSAI} \\ 23bds047@iiitdwd.ac.in}
\and
\IEEEauthorblockN{Ankit Kushwaha}
\IEEEauthorblockA{\textit{IIIT Dharwad} \\ \textit{DSAI} \\ 23bds008@iiitdwd.ac.in}
\and
\IEEEauthorblockN{Vijaypal Singh Rathore}
\IEEEauthorblockA{\textit{IIIT Dharwad} \\ \textit{DSAI} \\ 23bds067@iiitdwd.ac.in}
\and
\IEEEauthorblockN{}
\IEEEauthorblockA{
    \textbf{Instructor:} Dr. Girish Revadigar\\
    \textit{IIIT Dharwad}
}
}
