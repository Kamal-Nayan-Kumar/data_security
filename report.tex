...
\title{vget: A Secure Cryptographic Package Registry\\[0.3em]
\normalsize Course: Data Security and Privacy}

\author{
\makebox[\linewidth][c]{
    \resizebox{\linewidth}{!}{
        \begin{tabular}{c c c c}
        Kamal Nayan Kumar & Rahul Patel & Ankit Kushwaha & Vijaypal Singh Rathore \\
        \textit{IIIT Dharwad} & \textit{IIIT Dharwad} & \textit{IIIT Dharwad} & \textit{IIIT Dharwad} \\
        \textit{DSAI} & \textit{DSAI} & \textit{DSAI} & \textit{DSAI} \\
        23bds026@iiitdwd.ac.in & 23bds047@iiitdwd.ac.in & 23bds008@iiitdwd.ac.in & 23bds067@iiitdwd.ac.in
        \end{tabular}
    }
}
\\[1cm]
...
\begin{itemize}
    \item \textbf{Live Frontend URL:} \url{https://vget-teal.vercel.app/}
    \item \textbf{Official Documentation:} \url{https://mintlify.wiki/Kamal-Nayan-Kumar/vget}
    \item \textbf{GitHub Repository:} \url{https://github.com/Kamal-Nayan-Kumar/vget/}
\end{itemize}
